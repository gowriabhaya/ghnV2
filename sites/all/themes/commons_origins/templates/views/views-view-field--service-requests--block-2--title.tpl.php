...
// find out whether there is any matching available for this need nid
      ...
      if (count($ret) > 0) {
         print '<a href="'.$base_url.'/node/'.$fields[1].'" title="'.$fields[2].'">'.$fields[2].'</a> <a class="match-link" href="'.$base_url.'/match/need/'.$uid.'/'.$fields[1].'"><img src="'.$base_url.'/'.$theme_path.'/images/checkMark.png"></a>'; 
      }
      else {
