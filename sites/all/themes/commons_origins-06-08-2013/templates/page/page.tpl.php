...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <div id="columns" class="columns clearfix">
    ...
    <?php
/*
          $last_listart = strrpos($messages,'<li>');
          $last_liend = strrpos($messages,'</li>',$last_listart);
          $start = $last_listart +1;
          $length = $last_liend - $start +1;
          $newmsg = substr_replace($messages,'',$start,$length);
*/ 
          $sysmsg = "The changes have been saved.";
          $start = strpos($messages,$sysmsg,0);
/*
          $start = $last_listart +1;
          $length = $last_liend - $start +1;
          $start = $last_listart;
          $newmsg = $last_listart.'  '.$messages;
*/
          
          $length = $start + strlen($sysmsg);
          $newmsg = substr_replace($messages,'',$start,28);
    ?>
    <?php print $newmsg; ?>
    <?php //print $messages; ?>
